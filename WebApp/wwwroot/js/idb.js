...
// The store is shared across the origin (the Story web app uses the same DB), so callers pass their
// app's location prefix (e.g. "loc:") to list only their own projects; "" lists everything.
