...
namespace DeusaldLocalizerCommon
{
    ...
    public class DlocFileService
    {
        ...
        public const string FILTER_STRING          = "Localizer Project (*.dloc)|*.dloc";
    ...
    public class DlocFormatException : Exception
    {
        public DlocFormatException(string message) : base(message) { }
    }
}